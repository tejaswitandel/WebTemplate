  ...
  return (
    <>
      <Column className="bg-gray_100 font-dmsans items-center justify-start mx-[auto] w-[100%]">
        <header className="w-[100%]">
          <Column className="w-[100%]">
            <Row className="bg-white_A700 items-center justify-start w-[100%]">
              ...
              <Image
                src={"images/img_truckdelivery_4.svg"}
            ...
            <Row className="items-start justify-start lg:my-[21px] xl:my-[24px] my-[28px] 3xl:my-[33px] w-[100%]">
              ...
              <Row className="items-start justify-center xl:mb-[10px] mb-[12px] 3xl:mb-[14px] lg:mb-[9px] lg:ml-[49px] xl:ml-[56px] ml-[64px] 3xl:ml-[76px] w-[17%]">
                ...
                <Stack className="lg:h-[35px] xl:h-[40px] h-[44px] 2xl:h-[45px] 3xl:h-[53px] lg:ml-[31px] xl:ml-[35px] ml-[40px] 3xl:ml-[48px] w-[19%]">
                  <Image
                    src={"images/img_shoppingcart_4.svg"}
                ...
                <Image
                  src={"images/img_userprofile2_4.svg"}
                ...
                />
                <Image
                  src={"images/img_notificationbe_4.svg"}
        ...
        <Stack className="bg-white_A700 lg:h-[498px] xl:h-[570px] h-[640px] 2xl:h-[641px] 3xl:h-[769px] w-[100%]">
          <Image
            src={"images/img_maskgroup_3.svg"}
            className="absolute lg:h-[498px] xl:h-[570px] h-[640px] 2xl:h-[641px] 3xl:h-[769px] inset-[0] object-cover w-[100%]"
            alt="MaskGroup"
          />
          <Column className="absolute items-start justify-start right-[7%] top-[21%] w-[43%]">
            <Text className="font-bold leading-lh12000 mr-[10px] 3xl:mr-[12px] lg:mr-[7px] xl:mr-[8px] lg:text-fs49 xl:text-fs56 text-fs64 3xl:text-fs76 text-gray_900 text-left tracking-ls1 w-[97%]">{`Your Premium Sound, Unplugged!`}</Text>
            ...
            <Button className="bg-deep_orange_A200 font-bold mr-[10px] 3xl:mr-[12px] lg:mr-[7px] xl:mr-[8px] lg:mt-[43px] xl:mt-[49px] mt-[56px] 3xl:mt-[67px] lg:py-[15px] xl:py-[17px] py-[20.1px] 2xl:py-[20px] 3xl:py-[24px] rounded-radius8 text-center lg:text-fs12 xl:text-fs14 text-fs16 3xl:text-fs19 text-white_A700 tracking-ls1 w-[25%]">{`Find out More`}</Button>
          </Column>
        </Stack>
        <Column className="items-center justify-start xl:mt-[106px] mt-[120px] 3xl:mt-[144px] lg:mt-[93px] w-[100%]">
          <Text className="font-bold mx-[auto] lg:text-fs37 xl:text-fs42 text-fs48 3xl:text-fs57 text-gray_900 text-left tracking-ls1 w-[auto]">{`Our Premium Collection`}</Text>
        ...
        <Row className="items-start justify-start lg:mt-[124px] xl:mt-[142px] mt-[160px] 3xl:mt-[192px] w-[100%]">
          <div className="bg-gray_300 lg:h-[560px] xl:h-[641px] h-[720px] 2xl:h-[721px] 3xl:h-[865px] ml-[104px] 3xl:ml-[124px] lg:ml-[80px] xl:ml-[92px] rounded-radius8 w-[42%]"></div>
          <Column className="items-start justify-start lg:mb-[165px] xl:mb-[189px] mb-[213px] 3xl:mb-[255px] lg:ml-[37px] xl:ml-[42px] ml-[48px] 3xl:ml-[57px] 3xl:mt-[100px] lg:mt-[65px] xl:mt-[74px] mt-[84px] w-[35%]">
            <Text className="font-bold leading-lh12000 mr-[10px] 3xl:mr-[12px] lg:mr-[7px] xl:mr-[8px] lg:text-fs37 xl:text-fs42 text-fs48 3xl:text-fs57 text-gray_900 text-left tracking-ls1 w-[95%]">
              {
                <>
                  {`Story about`}
                  <br />
            ...
            <Text className="font-normal leading-lh12500 lg:mt-[24px] xl:mt-[28px] mt-[32px] 3xl:mt-[38px] not-italic text-bluegray_300 lg:text-fs12 xl:text-fs14 text-fs16 3xl:text-fs19 text-left tracking-ls1 w-[100%]">{`Develop a website by finding a product identity that has value and branding to become a characteristic of a company. We will also facilitate the business marketing of these products with our SEO experts so that they become a ready-to-use website and help sell a product from the company Develop a website by finding a product identity that has value and branding to become a characteristic of a company. We will also facilitate the business marketing of these products with our SEO experts so that they become a ready-to-use website and help sell a product from the company`}</Text>
            <Text className="font-bold mr-[10px] 3xl:mr-[12px] lg:mr-[7px] xl:mr-[8px] lg:mt-[43px] xl:mt-[49px] mt-[56px] 3xl:mt-[67px] text-deep_orange_A200 lg:text-fs12 xl:text-fs14 text-fs16 3xl:text-fs19 text-left tracking-ls1 w-[auto]">{`Read full story`}</Text>
          </Column>
        </Row>
        <Column className="items-center justify-start lg:mt-[155px] xl:mt-[177px] mt-[200px] 3xl:mt-[240px] mx-[auto] w-[86%]">
          <Text className="font-bold mx-[auto] text-center lg:text-fs37 xl:text-fs42 text-fs48 3xl:text-fs57 text-gray_900 tracking-ls1 w-[auto]">{`Our Achievement`}</Text>
          <Image
            src={"images/img_brandclientlo.svg"}
            className="h-[104px] 2xl:h-[105px] 3xl:h-[125px] lg:h-[81px] xl:h-[93px] lg:mt-[49px] xl:mt-[56px] mt-[64px] 3xl:mt-[76px] object-cover w-[100%]"
            alt="BrandClientLo"
          />
        </Column>
        <Stack className="lg:h-[340px] xl:h-[388px] h-[436px] 2xl:h-[437px] 3xl:h-[524px] lg:mt-[124px] xl:mt-[142px] mt-[160px] 3xl:mt-[192px] mx-[auto] w-[86%]">
          <Image
        ...
        <Column className="items-center justify-start lg:mt-[182px] xl:mt-[209px] mt-[235px] 3xl:mt-[282px] w-[100%]">
          <Row className="items-start justify-between w-[100%]">
            <Text className="font-bold leading-lh12000 ml-[104px] 3xl:ml-[124px] lg:ml-[80px] xl:ml-[92px] lg:text-fs37 xl:text-fs42 text-fs48 3xl:text-fs57 text-gray_901 text-left tracking-ls1 w-[35%]">{`Get Better Insights from Our Articles`}</Text>
            <Text className="font-bold lg:mb-[5px] xl:mb-[6px] mb-[7px] 3xl:mb-[8px] mr-[104px] 3xl:mr-[124px] lg:mr-[80px] xl:mr-[92px] lg:mt-[62px] xl:mt-[71px] mt-[80px] 3xl:mt-[96px] text-deep_orange_A200 lg:text-fs18 xl:text-fs21 text-fs24 3xl:text-fs28 text-right tracking-ls1 w-[auto]">{`See more`}</Text>
          </Row>
          <Grid className="lg:gap-[12px] xl:gap-[14px] gap-[16px] 3xl:gap-[19px] grid grid-cols-2 lg:mt-[43px] xl:mt-[49px] mt-[56px] 3xl:mt-[67px] mx-[auto] w-[86%]">
            <Column className="items-start justify-start w-[100%]">
              <Column className="w-[100%]">
                <div className="bg-gray_300 lg:h-[324px] xl:h-[371px] h-[416px] 2xl:h-[417px] 3xl:h-[500px] w-[100%]"></div>
              </Column>
              <Text className="font-bold lg:mt-[18px] xl:mt-[21px] mt-[24px] 3xl:mt-[28px] lg:text-fs24 xl:text-fs27 text-fs31 3xl:text-fs37 text-gray_900 text-left tracking-ls1 w-[auto]">{`Best Summer Outfit Style`}</Text>
              <Row className="items-start justify-start mr-[10px] 3xl:mr-[12px] lg:mr-[7px] xl:mr-[8px] lg:mt-[12px] xl:mt-[14px] mt-[16px] 3xl:mt-[19px] w-[26%]">
                <Text className="font-bold lg:text-fs12 xl:text-fs14 text-fs16 3xl:text-fs19 text-gray_800 text-left tracking-ls1 w-[auto]">{`14 Feb`}</Text>
                <div className="bg-gray_800 h-[4px] 3xl:h-[5px] 2xl:h-[5px] lg:mb-[5px] xl:mb-[6px] mb-[7px] 3xl:mb-[8px] lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] rounded-radius50 xl:w-[3px] lg:w-[3px] w-[4px]"></div>
                <Text className="font-bold lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:text-fs12 xl:text-fs14 text-fs16 3xl:text-fs19 text-gray_800 text-left tracking-ls1 w-[auto]">{`Livina Style`}</Text>
              </Row>
              <Text className="font-normal leading-lh12500 lg:mt-[12px] xl:mt-[14px] mt-[16px] 3xl:mt-[19px] not-italic text-bluegray_300 lg:text-fs12 xl:text-fs14 text-fs16 3xl:text-fs19 text-left tracking-ls1 w-[100%]">{`Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.`}</Text>
              <Text className="font-bold mr-[10px] 3xl:mr-[12px] lg:mr-[7px] xl:mr-[8px] lg:mt-[24px] xl:mt-[28px] mt-[32px] 3xl:mt-[38px] text-deep_orange_A200 lg:text-fs12 xl:text-fs14 text-fs16 3xl:text-fs19 text-left tracking-ls1 w-[auto]">{`Explore More`}</Text>
            </Column>
            <Column className="items-start justify-start w-[100%]">
              <Column className="w-[100%]">
                <div className="bg-gray_300 lg:h-[324px] xl:h-[371px] h-[416px] 2xl:h-[417px] 3xl:h-[500px] w-[100%]"></div>
